...
#   -------------------------------------------------------------------
    ii() {
        ...
        echo -e "\n${RED}Public facing IP Address :$NC " ;curl ifconfig.io
